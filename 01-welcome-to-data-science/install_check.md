...
1) [Download Anaconda](https://www.anaconda.com/distribution/#download-section) and follow the installation instructions package for your operating system. Please make sure that you're downloading the latest stable version for `Python 3.7`! <br>
...
```bash
conda install jupyter notebook pandas matplotlib nltk numpy pip setuptools scikit-learn scipy statsmodels
```
